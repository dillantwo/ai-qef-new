...
export default function EnglishReadingComprehensionCycle3Reading3ModesPage() {
  const router = useRouter();

  function navigateToMode(modeId: string, available: boolean) {
    if (!available) return;
    if (modeId === "roleplay") {
      router.push("/english/reading-comprehension/cycle-3-reading-3/roleplay");
      return;
    }
    if (modeId === "learning") {
      router.push("/english/reading-comprehension/cycle-3-reading-3/learning");
    }
  }
