...
const tasks = [
  { id: 1, label: "Task 1", prompt: "Let us start Task 1. Look at the map. How can I go from the post office to the hospital? Use prepositional phrases to describe the direction." },
