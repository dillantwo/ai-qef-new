...
export const SchoolMaterialLayout =
  (mongoose.models.SchoolMaterialLayout as mongoose.Model<ISchoolMaterialLayout> | undefined) ??
  mongoose.model<ISchoolMaterialLayout>("SchoolMaterialLayout", SchoolMaterialLayoutSchema);
